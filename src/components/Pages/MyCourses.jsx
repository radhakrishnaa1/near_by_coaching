  ...
  },
{
  ...
  return (
    <AuthLayout>
      <div style={{paddingTop:30,paddingBottom:30,display:"flex",justifyContent:"space-around"}}>
 ...
 <Card style={{ width: 300 ,textAlign:"center",paddingTop:100}}>
      <Avatar style={{ backgroundColor: '#fde3cf', color: '#f56a00' }} size={64} icon={<PlusOutlined />} />
